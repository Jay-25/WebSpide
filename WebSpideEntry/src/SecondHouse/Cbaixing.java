...
public class Cbaixing extends SpideEntryBase {
	...
	private void loadRegexRule() {
		...
		// 朝向
		regexTable.set("build_face", CRegexLib.houseFaceRegex("房?间?朝向[:\\s]*", ""), CRegexLib
		                .houseFaceRegex("朝\\s*", ""));
		// 楼层
		...
		// 地址
		regexTable.set("address", CRegexLib.addressRegex("地处", ""), CRegexLib
		                .addressRegex("临近", ""), CRegexLib.addressRegex("详情介绍", "地图及交通"), CRegexLib
		                .addressRegex("", ""));
		// 开发商
