...
set APP=WebSpideOutput4CaiShiChang.jar
::set APP_PARAS=-c E:\Homework\Ing\WebSpide\WebSpideEntry\CaiShiChang_webspide.ini -quiet
set APP_PARAS=-c E:\Homework\Ing\WebSpide\WebSpideEntry\CaiShiChang_webspide.ini -test -quiet
