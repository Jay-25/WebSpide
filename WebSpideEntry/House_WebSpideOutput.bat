...
set APP=WebSpideOutput4House.jar
::set APP_PARAS=-c E:\Homework\Ing\WebSpide\WebSpideEntry\House_webspide.ini
set APP_PARAS=-c E:\Homework\Ing\WebSpide\WebSpideEntry\House_webspide.ini -test
