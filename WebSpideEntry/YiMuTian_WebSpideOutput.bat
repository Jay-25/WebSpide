...
set APP=WebSpideOutput4YiMuTian.jar
::set APP_PARAS=-c E:\Homework\Ing\WebSpide\WebSpideEntry\YiMuTian_webspide.ini
set APP_PARAS=-c E:\Homework\Ing\WebSpide\WebSpideEntry\YiMuTian_webspide.ini -test
