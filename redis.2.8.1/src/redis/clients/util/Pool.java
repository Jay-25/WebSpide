...
public abstract class Pool<T> implements Closeable {
	...
	public T getResource() {
		try {
			...
			throw new JedisException("Could not get a resource from the pool" + "<" + nse.getMessage() + ">", nse);
		}
		catch (Exception e) {
			throw new JedisConnectionException("Could not get a resource from the pool" + "<" + e.getMessage() + ">", e);
		}
	}
